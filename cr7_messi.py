...
def clean_cr7():
    read_path = '/home/julian/DATA_ENGINEERING/Data_Models/'
    file = 'cr7.csv'
...
with DAG('cr7_messi_data_processing', schedule_interval = '@daily', catchup=False, default_args=default_dag_args) as cr7messi_dag:
    ...
    task_2 = PythonOperator(task_id='create_database_table_insert_values', python_callable=create_database_tables_insert_values)
    task_3 = BashOperator(task_id = 'moving_cr7_data', bash_command = "cp /home/julian/DATA_ENGINEERING/Data_Models/cleaned_data/cr7.csv  \
                          /home/julian/Rondaldo_Messi_Project")
    task_4 = BashOperator(task_id = 'moving_messi_data', bash_command = "cp /home/julian/DATA_ENGINEERING/Data_Models/cleaned_data/messi.csv  \
                          /home/julian/Rondaldo_Messi_Project")         
    task_5 = BashOperator(task_id = 'moving_code_file', bash_command = "cp /home/julian/airflow/dags/cr7_messi.py  \
                          /home/julian/Rondaldo_Messi_Project")   
